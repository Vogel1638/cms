...
$profileImage = $user['profile_image'] ? BASE_URL . $user['profile_image'] : '';

$content = '
<div class="user-form-admin">
    <div class="user-form-header">
        <h2>Benutzer bearbeiten: ' . $this->escape($fullName) . '</h2>
            ...
            <div class="form-tabs">
                ...
                <div class="tab-content active" id="general">
                    <div class="profile-image-section">
                        ...
                        <div class="profile-image-upload">
                            <div class="current-image">
                                ' . ($profileImage ? '<img src="' . $profileImage . '" alt="Aktuelles Profilbild" class="profile-preview">' : '<div class="profile-preview-placeholder"></div>') . '
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="username" name="username" value="' . $this->escape($user['username']) . '" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="full_name">Vollständiger Name: *</label>
                        <input type="text" id="full_name" name="full_name" value="' . $this->escape($fullName) . '" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="email">E-Mail-Adresse: *</label>
                        <input type="email" id="email" name="email" value="' . $this->escape($user['email'] ?? '') . '" required>
                    </div>
                ...
                <div class="tab-content" id="security">
                    <div class="form-group">
                        ...
                        <input type="password" id="new_password" name="new_password" placeholder="Leer lassen für keine Änderung">
                        <small>Lassen Sie das Feld leer, wenn Sie das Passwort nicht ändern möchten.</small>
                    </div>
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const preview = document.querySelector(".profile-preview, .profile-preview-placeholder");
